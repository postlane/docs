...
Write all three files into `.postlane/posts/YYMMDD-show-hn/` where `YYMMDD` is today's date (e.g. `260620` for 20 June 2026). If a folder with that name already exists, append `-2` to avoid overwriting.
...
> Written to `.postlane/posts/YYMMDD-show-hn/`. The draft will appear in the Postlane desktop app queue.
